...
if __name__ == '__main__':
    ...
    body = [
        '{"taxNo":"' + taxNo + '", "customerOrderNo":"' + sys.argv[3] + '", "amount":"' + sys.argv[4] + '", "subject":"' + sys.argv[5] + '", "payee":"' + sys.argv[6] + '", "sellerNote":"' + sys.argv[7] + '", "billingType":"1", "autoType":"1", "invoiceExpire":"360", "returnUrl":"http://znxf.shznxfxx.cn:3000", "appKey":"' + appKey + '"}',
