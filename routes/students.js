...
router.post('/new_student', function (req, res, next) {
  ...
  params = { mark: 0, username: req.body.username, name: req.body.name, password: req.body.password, kindID: req.body.kindID, companyID: req.body.companyID, dept1: req.body.dept1, dept1Name: req.body.dept1Name, dept2: req.body.dept2, dept3: req.body.dept3, job: req.body.job,job_status:1, mobile: req.body.mobile, phone: req.body.phone, email: req.body.email, address: req.body.address, limitDate: req.body.limitDate, unit:'', dept:'',ethnicity:'',IDaddress:'',bureau:'',IDdateStart:'',IDdateEnd:'',experience: req.body.experience, memo: req.body.memo, education: req.body.education, host: cid, registerID: req.body.username };
